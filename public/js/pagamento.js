document.addEventListener('DOMContentLoaded', () => {
    ...
    function preencherTela() {
        ...
        dataDevolucao.setDate(dataRetirada.getDate() + parseInt(reservaData.dias || 0));
    ...
    try {
        ...
        if (!reservaData || !reservaData.id_veiculo) throw new Error("Dados de reserva incompletos.");
        preencherTela();
    } catch (e) {
